...
#### Flow
import FlowImg from "../../assets/blog_assets/concert-tour-scrapper-with-cheerio-simplecrawler/RHCP-Mindmap.png"

<>
  <p><img src={FlowImg} alt="Alt text" title="RHCP-Mindmap" /></p>
</>
...
import RHCPPastTourImg from "../../assets/blog_assets/concert-tour-scrapper-with-cheerio-simplecrawler/RHCP-Past-Tour.png"

<>
  <p><img src={RHCPPastTourImg} alt="Alt text" title="RHCP Past Tour" /></p>
</>


On opening the Chrome inspector tools and focusing on one entry, we can figure out how we want to parse this page:

import RHCPPastTourInspectorImg from "../../assets/blog_assets/concert-tour-scrapper-with-cheerio-simplecrawler/RHCP-Tour-Past-Inspector.png"

<>
  <p><img src={RHCPPastTourImg} alt="Alt text" title="RHCP Tour Past Inspector" /></p>
</>
...
import RHCPastTourPaginationImg from "../../assets/blog_assets/concert-tour-scrapper-with-cheerio-simplecrawler/RHCP-Past-Tour-Pagination.png"

<>
  <p><img src={RHCPastTourPaginationImg} alt="Alt text" title="RHCP-Past-Tour-Pagination" /></p>
</>

Inspecting this element we see this:

import RHCPPastTourPaginationInspectorImg from "../../assets/blog_assets/concert-tour-scrapper-with-cheerio-simplecrawler/RHCP-Past-Tour-Pagination-Inspector.png"

<>
  <p><img src={RHCPPastTourPaginationInspectorImg} alt="Alt text" title="RHCP-Past-Tour-Pagination-Inspector" /></p>
</>
...
import MiddlewareImg from "../../assets/blog_assets/concert-tour-scrapper-with-cheerio-simplecrawler/Middleware.png"

<>
  <p><img src={MiddlewareImg} alt="Alt text" title="Middleware" /></p>
</>
